                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form id="<?php echo $isEmpty ? 'registerForm' : 'loginForm'; ?>" method="POST">
                        ...
                        <button type="button" id="forgotPasswordBtn"
                            class="w-full mt-4 text-white bg-gray-500 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
